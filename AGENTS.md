...
`GENERATED` header naming the command that regenerates it. Currently generated:
_none yet_ (the table grows with Milestone 2+). Hand-written: everything else.
Never hand-add an entry to a shell that renders generated data.
