...
| sigil     | draft  | Sigil implementation session (Claude, sup. Louis Tinthilier) | `feat/sigil` | #47 | 4        | `packages/ui/src/components/sigil/Sigil.rfc.md`     | Fourth component candidate: the framed square the site's heroes carry (art in the live accent, two inset rings, a corner label) — usage analysis `process/archives/2026-09-26-sigil-usage-analysis.md` (5 mounts on 9 pages under 3 recipes), design record `process/archives/2026-09-26-sigil-design.md` (12 questions arbitrated in session 2026-09-26, two of them at the design lead's Figma checkpoint: no label, art inside the accent ring). No library dependency. Priority 4 set by the design lead 2026-09-26. RFC approved 2026-09-26 (§7 Q13, after the design lead's own Figma edit); no Figma docs page (page-less path, rules in RFC §7). Implementation next (`feat/sigil`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | —               |
