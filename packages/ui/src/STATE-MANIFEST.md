...
| callout   | draft  | callout session (Claude) | `feat/callout-rfc` | —   | —        | `packages/ui/src/components/callout/Callout.rfc.md` | Second component through the circuit. Figma set 61:26 seeded from the site 2026-09-11, docs page `Docs / Callout` (66:3) written with Louis; four arbitrations already taken on the page (tag type/meta, title type/h3, glyph decorative, grid product-side). Priority: Louis to set.                                                                                              | —               |
