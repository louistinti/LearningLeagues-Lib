...
| You added a new component scaffold                | Don't touch the red violations — they're intentional proof that gates aren't default. Fix them in order: token-lint → contrast → contract.json → RFC.                           |
